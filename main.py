...
sym_des = pd.read_csv("am dataset\symtoms_am - symtoms_df (1).csv")
precautions = pd.read_csv("am dataset\symtoms_am - precautions_df.csv")
workout = pd.read_csv("am dataset\symtoms_am - workout_df.csv")
description = pd.read_csv("am dataset\symtoms_am - description (1).csv")
medications = pd.read_csv('am dataset\symtoms_am - medications.csv')
diets = pd.read_csv("am dataset\symtoms_am - diets.csv")


# load model===========================================
svc = pickle.load(open('models/svc.pkl','rb'))
svc = pickle.load(open('models/svc_am.pkl','rb'))
